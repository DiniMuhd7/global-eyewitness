...
import kotlinx.android.synthetic.main.compaint_main.*
...
class ComplaintActivity: AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.compaint_main)
        mContext = this
        ...
        btnApproved.setOnClickListener {
            ...
            if (uid != null) {
                ...
                mComplaintAdapter.deleteItem(cardList) // Delete all items in recycler view
                ...
                db.collection("officer")
                        ...
                        .addOnSuccessListener { result ->
                            for (document in result) {
                                ...
                                if (reviewStat != null && reviewStat.equals("Approved", true)) {
                                    ...
                                    mComplaintAdapter = ComplaintAdapter(mIncidentMute, mContext)
                                    cardList.layoutManager = LinearLayoutManager(this, LinearLayout.VERTICAL, false)
                                    cardList.adapter = mComplaintAdapter
                        ...
                        .addOnFailureListener { exception ->
                            ...
                            Toast.makeText(this@ComplaintActivity, "Sorry, something went wrong.", Toast.LENGTH_LONG).show()
                        }
            ...
            db.collection("accident")
                    ...
                    .addOnSuccessListener { result ->
                        for (document in result) {
                            ...
                            val defaultMessage = findViewById<View>(R.id.defaultMessageTextView) as TextView
