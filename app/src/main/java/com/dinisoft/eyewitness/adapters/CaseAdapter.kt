...
import kotlinx.android.synthetic.main.case_card_layout.view.*
import java.io.File
...
class CaseAdapter (private val incidentList: List<Incident>, val mContext: Context) : RecyclerView.Adapter<CaseAdapter.IncidentViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): IncidentViewHolder {
        val v = LayoutInflater.from(viewGroup.context).inflate(R.layout.case_card_layout, viewGroup, false)
