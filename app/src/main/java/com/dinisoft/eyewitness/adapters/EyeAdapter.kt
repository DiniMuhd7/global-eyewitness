...
import kotlinx.android.synthetic.main.user_card_layout.view.utterance


/**
 * Created by Shamsudeen A. Muhammed (c) 2021
 */
class EyeAdapter(private val utteranceList: List<Utterance>, private val ctx: Context, private val menuInflater: MenuInflater) : RecyclerView.Adapter<EyeAdapter.UtteranceViewHolder>() {
