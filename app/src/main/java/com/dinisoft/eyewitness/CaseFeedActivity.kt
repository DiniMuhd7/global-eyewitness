...
import com.dinisoft.eyewitness.adapters.CaseAdapter
...
import kotlinx.android.synthetic.main.case_main.*
import kotlinx.android.synthetic.main.case_main.cardList
import kotlinx.android.synthetic.main.case_main.defaultMessageTextView
...
class CaseFeedActivity: AppCompatActivity(){

    private val TAG: String = "--CaseFeedActivity"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        geocoder = Geocoder(this@CaseFeedActivity, Locale.getDefault())
        // Construct a FusedLocationProviderClient.
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(mContext as CaseFeedActivity)
        ...
        btnState.setOnClickListener {
            ...
            if (uid != null) {
                ...
                mCaseAdapter.deleteItem(cardList) // Delete all items in recycler view

                if (::mState.isInitialized){
                    db.collection("officer")
                            .whereEqualTo("state", mState)
                            ...
                            .addOnSuccessListener { result ->
                                for (document in result) {
                                    ...
                                    if (reviewStat != null && reviewStat.equals("Approved", true) && visibility.equals("public", true)) {
                                        ...
                                        mCaseAdapter = CaseAdapter(mIncidentMute, mContext)
                                        cardList.layoutManager = LinearLayoutManager(this, LinearLayout.VERTICAL, false)
                                        cardList.adapter = mCaseAdapter
                            ...
                            .addOnFailureListener { exception ->
                                ...
                                Toast.makeText(this@CaseFeedActivity, "Sorry, something went wrong.", Toast.LENGTH_LONG).show()
                            }
