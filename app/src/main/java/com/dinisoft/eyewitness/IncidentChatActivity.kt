...
import com.dinisoft.eyewitness.adapters.IncidentChatAdapter
...
class IncidentChatActivity: AppCompatActivity(){

    private val TAG: String = "--IncidentChatActivity"
    private val logTag = "IncidentChatLog"
    ...
    private lateinit var mIncidentChatAdapter: IncidentChatAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.incident_chat_main)
        ...
        mIncidentChatAdapter = IncidentChatAdapter(utterances, applicationContext, menuInflater)
        mIncidentChatAdapter.setOnLongItemClickListener(object : IncidentChatAdapter.OnLongItemClickListener {
        ...
        val incidentID = intent.getStringExtra("Tag")
            ...
            db.collection("chats")
                ...
                .addOnSuccessListener { result ->
                    ...
                    for (document in result){
                        ...
                        addData(Utterance(message.toString(), UtteranceFrom.USER, username.toString(), cdate.toString()))
                    }
    ...
    private fun addData(mycroftUtterance: Utterance) {
        ...
        mIncidentChatAdapter.notifyItemInserted(utterances.size - 1)
        ...
        cardList.smoothScrollToPosition(mIncidentChatAdapter.itemCount - 1)
    }
    ...
    fun sendMessage(msg: String) {
        ...
        try {
            ...
            if (currentUserID != null) {
                ...
                addChatToFirebase(msg, username.toString(), fullLocaleTime, incidentID!!, photoURL.toString())

                // Add data to the recyler view adapter
                addData(Utterance(msg, UtteranceFrom.USER, username.toString(), fullLocaleTime.toString()))
    ...
    private fun addChatToFirebase(messageUtterance: String, uid: String, mdate: String, mIncidentID: String, photoURL: String){

        val chats = hashMapOf(
                "uid" to uid,
                "documentID" to "",
                "message" to messageUtterance,
                "date" to mdate,
                "incidentID" to mIncidentID,
        ...
        db.collection("chats")
                ...
                .addOnSuccessListener { documentReference ->
                    ...
                    val modifyRef = db.collection("chats").document(documentReference.id)
    ...
    private fun loadPreferences() {
        ...
        if (wsip!!.isEmpty()) {
            ...
            startActivity(Intent(this, IncidentChatActivity::class.java))
    ...
    private fun recordVersionInfo() {
        try {
            ...
            val editor = sharedPref.edit()
            editor.putInt(Constants.EyewitnessMobileConstants.VERSION_CODE_PREFERENCE_KEY, packageInfo.versionCode)
            editor.putString(Constants.EyewitnessMobileConstants.VERSION_NAME_PREFERENCE_KEY, packageInfo.versionName)
            editor.apply()
